...
def register_best_model():
    ...
    mlflow.register_model(
        model_uri=f"runs:/{best_run.info.run_id}/model", name=MODEL_NAME
    )
    ...
    mlflow.artifacts.download_artifacts(
        artifact_uri=f"runs:/{best_run.info.run_id}/model.pickle",
...
def main():
    ...
    parser.add_argument(
        "--k_folds", default=3, help="the number of different folds to train data"
    )
